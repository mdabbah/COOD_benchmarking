...
class ImageNetClip(torch.nn.Module):
    def __init__(self, model, linear_probe=False, preprocess=None, imagenet_train_folder='../ImageNet/train', name='CLIP', train_batchsize=16):
        ...
        if linear_probe:
            ...
            checkpoint_path = f'CLIP_linear_probes/{name}.pkl'
            ...
            self.zeroshot_classifier = zeroshot_classifier(imagenet_classes, imagenet_templates, self.clip)
