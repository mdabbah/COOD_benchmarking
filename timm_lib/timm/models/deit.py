...
from timm_lib.timm.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from timm_lib.timm.models.vision_transformer import VisionTransformer, trunc_normal_, checkpoint_filter_fn
